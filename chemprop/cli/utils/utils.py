...
TABLE_READ_FORMATS = (".csv", ".parquet", ".feather")
TABLE_WRITE_FORMATS = (".csv", ".parquet", ".feather", ".pkl")
...
def read_table(
    ...
    if suffix == ".csv":
        ...
        raise ValueError(
            f"Unsupported file format: {suffix}. Supported formats are: {', '.join(TABLE_READ_FORMATS)}"
        )
...
def write_table(
    ...
    if suffix == ".csv":
        ...
        raise ValueError(
            f"Unsupported file format: {suffix}. Supported formats are: {', '.join(TABLE_WRITE_FORMATS)}"
        )
